...
3. ตัวอย่างการประยุกต์ใช้คิวในการจำลองการรอคิวร้านอาหาร จะเกิดความผิดพลาดในการทำงานกรณีใด จงอธิบาย และจะแก้ไข Code อย่างไรเพื่อแก้ไขปัญหาดังกล่าว (สร้างไฟล์ใหม่ ตั้งขื่อ UpdateQueueRestaurant.py)
        ...
        ในโค้ดไม่ได้กำหนดคลาส Queue หรือไม่มีการนำเข้าคลาสนี้จากที่อื่นทำให้โปรแกรมเกิดข้อผิดพลาด เพราะโปรแกรมจะไม่รู้จักคำว่า Queue แก้ปัญหาโดยต้องสร้างคลาส Queue ขึ้นมาเองในโค้ดหรือต้องนำเข้าคลาส Queue จากไลบรารีหรือไฟล์ที่อื่นที่ได้ประกาศคลาสนี้ไว้
