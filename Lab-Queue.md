...
| รูปผลการทดลอง |
 ...
 ![Screenshot 2025-01-02 104753](https://github.com/user-attachments/assets/7c7c199b-b661-4ff0-81ff-89174ae2d528)
 ...
 *ตอบ อาจเกิดปัญหาหากคิวว่างเมื่อเสิร์ฟลูกค้า, คิวเต็มเมื่อเพิ่มลูกค้า, หรือมีข้อมูลลูกค้าซ้ำกันโดยไม่ตรวจสอบความถูกต้องก่อน การแก้ไขสามารถทำได้โดยการเพิ่มการตรวจสอบเงื่อนไขต่างๆ เช่น คิวว่าง, คิวเต็ม, และการจัดการข้อมูลที่ซ้ำซ้อน. การจัดการเหล่านี้จะช่วยให้โปรแกรมทำงานได้ถูกต้อง
...
1. Queue ต่างจาก Stack อย่างไร?
   ...
   *ตอบ เป็นโครงสร้างข้อมูลที่ใช้หลักการ First In First Out (FIFO) หรือ เข้าก่อนออกก่อน ซึ่งหมายความว่า ข้อมูลที่ถูกเพิ่มเข้าไปก่อนจะถูกนำออกก่อน
...
3. เพราะเหตุใดการ dequeue จึงใช้ pop(0) แทนที่จะเป็น pop()?
   ...
   *ตอบ เป็นโครงสร้างข้อมูลที่ใช้หลักการ Last In First Out (LIFO) หรือ เข้าล่าสุดออกก่อน ซึ่งหมายความว่า ข้อมูลที่ถูกเพิ่มเข้าไปล่าสุดจะถูกนำออกก่อน
...
7. หากต้องการทำ Priority Queue จะต้องปรับปรุงโค้ดอย่างไร?
    ...
    *ตอบ ใช้ heapq ใน Python ซึ่งเป็นโมดูลสำหรับจัดการ heap (min-heap) เพื่อให้สามารถเข้าถึงข้อมูลที่มีความสำคัญสูงสุดได้อย่างรวดเร็ว
