...
# ทดสอบ 5: ดูข้อมูลตัวสุดท้ายในคิว
last_item = q.peek_last()
if last_item is not None:
    print("ข้อมูลตัวสุดท้ายในคิว:", last_item)  # ควรได้ 3

# ทดสอบ 6: นำข้อมูลออกจนคิวว่าง
q.dequeue()
q.dequeue()
q.display()  # ควรได้ []
q.dequeue()  # ควรแสดงข้อความแจ้งว่า "คิวว่าง"

# ทดสอบ 7: ดูข้อมูลตัวสุดท้ายในคิวเมื่อคิวว่าง
last_item = q.peek_last()
if last_item is None:
    print("ไม่มีข้อมูลในคิว")  # ควรแสดงข้อความแจ้งว่า "คิวว่าง"
